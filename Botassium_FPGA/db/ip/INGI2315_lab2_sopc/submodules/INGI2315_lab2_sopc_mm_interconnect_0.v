// INGI2315_lab2_sopc_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module INGI2315_lab2_sopc_mm_interconnect_0 (
	...
	wire  [93:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> onchip_mem_s1_agent:cp_data
	...
	wire  [94:0] button_s1_agent_rf_source_data;                                            // Button_s1_agent:rf_source_data -> Button_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] button_s1_agent_rsp_fifo_out_data;                                         // Button_s1_agent_rsp_fifo:out_data -> Button_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> Button_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // Button_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> Button_s1_agent:cp_channel
	...
	wire  [93:0] onchip_mem_s1_agent_rp_data;                                               // onchip_mem_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [93:0] button_s1_agent_rp_data;                                                   // Button_s1_agent:rp_data -> router_006:sink_data
	...
	INGI2315_lab2_sopc_mm_interconnect_0_router router (
	...
	INGI2315_lab2_sopc_mm_interconnect_0_router_001 router_001 (
	...
	INGI2315_lab2_sopc_mm_interconnect_0_router_002 router_002 (
	...
	INGI2315_lab2_sopc_mm_interconnect_0_router_003 router_003 (
	...
	INGI2315_lab2_sopc_mm_interconnect_0_router_003 router_004 (
	...
	INGI2315_lab2_sopc_mm_interconnect_0_router_002 router_005 (
	...
	INGI2315_lab2_sopc_mm_interconnect_0_router_002 router_006 (
	...
	INGI2315_lab2_sopc_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	INGI2315_lab2_sopc_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	INGI2315_lab2_sopc_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	INGI2315_lab2_sopc_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	INGI2315_lab2_sopc_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	INGI2315_lab2_sopc_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	INGI2315_lab2_sopc_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	INGI2315_lab2_sopc_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	INGI2315_lab2_sopc_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	INGI2315_lab2_sopc_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	INGI2315_lab2_sopc_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	INGI2315_lab2_sopc_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	INGI2315_lab2_sopc_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	INGI2315_lab2_sopc_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	INGI2315_lab2_sopc_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
